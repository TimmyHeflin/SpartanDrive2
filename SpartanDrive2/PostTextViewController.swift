...
class PostTextViewController: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//        }
    ...
    private func handleSuccessUpload(){
        ...
        performSegue(withIdentifier: "UploadTextSuccess", sender: self)
    }
